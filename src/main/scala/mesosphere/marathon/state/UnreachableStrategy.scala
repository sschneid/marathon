...
sealed trait UnreachableDisabled extends UnreachableStrategy
case object UnreachableDisabled extends UnreachableDisabled {
...
object UnreachableStrategy {
  ...
  // val default = UnreachableStrategy(DefaultInactiveAfter, DefaultExpungeAfter)
